...
<div class="Freelancer-Container">
        ...
        <div class="Freelancer-Header">
            <div class="Freelancer-HeaderTitle">CREATE AN ACCOUNT AS A FREELANCER</div>
        ...
        <div class="Freelancer-Content">
            ...
            <form action="Backend/Freelancer_Register.backend.php" method="post" enctype = "multipart/form-data" id="RegForm">
